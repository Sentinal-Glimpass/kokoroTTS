...
CMD ["gunicorn", "src.main:app", "--workers", "10", "--worker-class", "uvicorn.workers.UvicornWorker", "--worker-connections", "1", "--bind", "0.0.0.0:8000", "--log-level", "info", "--access-logfile", "-", "--error-logfile", "-"]
